...
func NewHTTPHandler(endpoints mathendpoint.Set, logger log.Logger) http.Handler {
...
func err2code(err error) int {
	switch err {
	case mathservice.ErrDivideByZero, mathservice.ErrNoMax, mathservice.ErrNoMin:
...
func decodeHTTPMathOpRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var req mathendpoint.MathOpRequest
...
func decodeHTTPMathOpResponse(_ context.Context, r *http.Response) (interface{}, error) {
	...
	var resp mathendpoint.MathOpResponse
